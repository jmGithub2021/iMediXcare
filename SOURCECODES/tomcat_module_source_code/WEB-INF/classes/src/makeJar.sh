cp -r /home/surajit/Opensource/SOURCECODES/server_module_source_code/imedix `pwd`

/home/surajit/Opensource/jdk11/bin/javac -classpath ".:/home/surajit/Opensource/External_library/*:" -d `pwd` *.java 

/home/surajit/Opensource/jdk11/bin/javac -classpath ".:/home/surajit/Opensource/External_library/*:" -d `pwd`/src_servlet *.java 
cp -r `pwd`/src_servlet/imedixservlets/* `pwd`/imedixservlets

/home/surajit/Opensource/jdk11/bin/jar -cf  imedix.jar imedix/*.class
/home/surajit/Opensource/jdk11/bin/jar -cf  telem.jar telem/*.class
...
/home/surajit/Opensource/jdk11/bin/jar -cf  imedixservlets.jar imedixservlets/*.class
cp -r *.jar /home/surajit/Opensource/Tomcat9/webapps/iMediXcare/WEB-INF/lib
