...
<%
	...
	/*  String primaryEmail = "",primaryPhone="";
	    Object res=rcui.getuserinfo(userid); 
	    Vector tmp = (Vector)res;
	    if(tmp.size()>0){
	      dataobj temp = (dataobj) tmp.get(0);    
	      primaryEmail = temp.getValue("emailid").trim();
	      primaryPhone = temp.getValue("phone").trim();
	    }
	    */
%>
<%!
...
<div class="col-sm-12">
<div class="row 1-1 well"><center><h4 style="color:blue"><b>FAMILY MEMBER'S DETAILS</b></h4></center>
<div class="col-sm-6 ">
...
<input class="form-control" id="pri-patid" NAME="primarypatid" data-toggle="tooltip" data-placement="top" title="Patient id of primary account holder" maxlength="20" value="<%=userid%>" readonly=true required><!-- "form-control" -->
</div>
