...
<% 
	...
	String tabRows=rcStat.getDiseaseData(sccode,uid);
	String barImgUrl="../temp/"+uid+"/statimg/disbar.gif";
	String pieImgUrl="../temp/"+uid+"/statimg/dispie.gif";
...
<ul class="nav nav-pills nav-justified">
    <li><a class="btn btn-default" href="#" value="diseasetype.jsp?sccode=<%=sccode%>&chart=bar" onclick="s_kundu(this.getAttribute('value'))" style="background-color:#00FFFF;color:#707070"> Bar Chart</a></li>
    <li><a class="btn btn-default" href="#" value="diseasetype.jsp?sccode=<%=sccode%>&chart=pie" onclick="s_kundu(this.getAttribute('value'))" style="background-color:#00FFFF;color:#707070"> Pie Chart</a></li>
    <li><a class="btn btn-default" href="#" value="diseasetype.jsp?sccode=<%=sccode%>&chart=all" onclick="s_kundu(this.getAttribute('value'))" style="background-color:#00FFFF;color:#707070"> All Chart</a></li>
...
<TABLE class="table table-bordered" width=100%>
			 <TR bgcolor='#330099'>
				...
				<TD  ><B><FONT COLOR="white">Disease</FONT></B></TD>
...
<div class="col-sm-6">
<div class="well"><FONT SIZE="4" COLOR="#3300CC"><B>Disease Type Statistics of <%=hosname%></B></Font>
		...
		%>
			<TR >
				...
				<TD valign='top'> <img class="img-responsive" src='<%=barImgUrl%>' usemap='#disbar' /></TD>
			</TR>
		<%
		  }
		...
		%>
		<TR >
			<TD valign='top'> <img class="img-responsive" src='<%=pieImgUrl%>' usemap='#dispie' /> </TD>  
		</TR>
		<%
		  }
		%>
