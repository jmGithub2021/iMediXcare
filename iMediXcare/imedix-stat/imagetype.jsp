...
<% 
	...
	String tabRows=rcStat.getImageData(sccode,uid);
	String barImgUrl="../temp/"+uid+"/statimg/imgbar.gif";
	String pieImgUrl="../temp/"+uid+"/statimg/imgpie.gif";
...
<ul class="nav nav-pills nav-justified">
    <li><a class="btn btn-default" href="#" value="imagetype.jsp?sccode=<%=sccode%>&chart=bar" onclick="s_kundu(this.getAttribute('value'))" style="background-color:#00FFFF;color:#707070"> Bar Chart</a></li>
    <li><a class="btn btn-default" href="#" value="imagetype.jsp?sccode=<%=sccode%>&chart=pie" onclick="s_kundu(this.getAttribute('value'))" style="background-color:#00FFFF;color:#707070"> Pie Chart</a></li>
    <li><a class="btn btn-default" href="#" value="imagetype.jsp?sccode=<%=sccode%>&chart=all" onclick="s_kundu(this.getAttribute('value'))" style="background-color:#00FFFF;color:#707070"> All Chart</a></li>
...
<div class="col-sm-6">
<div class="well"><FONT SIZE="4" COLOR="#3300CC"><B>Image Type Statistics of <%=hosname%></B></FONT>
		...
		%>
			<TR >
				...
				<TD valign='top'> <img class="img-responsive" src='<%=barImgUrl%>' usemap='#imgbar' /></TD>
			</TR>
		<%
		  }
		...
		%>
		<TR >
			<TD valign='top'> <img class="img-responsive" src='<%=pieImgUrl%>' usemap='#imgpie' /> </TD>  
		</TR>
		<%
		  }
		%>
